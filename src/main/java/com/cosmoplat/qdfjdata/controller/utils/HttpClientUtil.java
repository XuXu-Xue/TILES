...
public class HttpClientUtil {
    ...
    public ExecuteResult<String> post(String uri, Object params) {
        HttpPost httpPost = new HttpPost(uri);
        CloseableHttpResponse response = null;
        try {
            StringEntity paramEntity = new StringEntity(JSONObject.toJSONString(params));
            ...
            if (code == HttpStatus.SC_OK) {
                ...
                return ExecuteResult.fail("请求{}返回错误码:"+uri+",请求参数:"+params+",结果"+result+"code");
            }
        } catch (IOException e) {
